...
const MuestraCobro = () => {
  return (
    ...
    <><Container className="d-flex justify-content-center mt-5 mb-5">
          <Form className="text-center w-50" onSubmit={handleSubmit}>
      ...
      </Container><Container className="d-flex justify-content-center mt-5 mb-5">
          ...
          </Container><Container className="mb-5 mt-3 text-center w-50">
              <Form>
              ...
              <Button as={Link} to="/mostrarCobro">
                  Cobrar
              </Button>
          </Container></>
              );
